...
- [x] ERD 다이어그램 작성
- [ ] API 엔드포인트 설계
- [ ] Flutter 프로젝트 아키텍처 설계
- [ ] 크롤링 시스템 설계
- [ ] 145개 크라우드펀딩 사이트 목록 정리
  - [ ] 국가별 분류
  - [ ] 카테고리별 분류
  - [ ] 크롤링 우선순위 결정
...
- [ ] Git 저장소 초기화
- [ ] README.md 작성
- [ ] 코드 포맷팅 설정 (analysis_options.yaml)
...
#### 2.3 기본 UI 컴포넌트
- [ ] 테마 설정 (AppColors, AppTypography)
- [ ] 커스텀 위젯 제작
  - [ ] TradeWindsAppBar (앱바)
  - [ ] TreasureCard (상품 카드)
  - [ ] CompassLoading (로딩 인디케이터)
  - [ ] GoldButton (CTA 버튼)
